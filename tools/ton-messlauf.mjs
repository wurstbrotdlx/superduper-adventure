...
const QUELLEN = [
  ...
  // T6: der laute Kanal, und er steht als EIGENE Quelle statt im Band. Nicht aus
  ...
  //
  // Ohne diesen Eintrag waeren die zweiundzwanzig Zeilen ungemessen gewesen,
  // und das ist derselbe Fall wie beim Auftakt vier Zeilen weiter unten: eine
  // Textquelle, die kein Lauf erfasst, driftet still, und der Bericht behauptet
  // dabei eine Vollstaendigkeit, die er nicht hat.
