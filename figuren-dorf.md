...
Optik: `cfnpc_bruno` (Bartender_Bruno, wandert). Heimatanker: Kachel (24, 38). **Er ist der Einzige des Ensembles, der auf seinem Paketblatt läuft statt auf dem Komposit seines Porträts** — das Pack hat einen fertigen Wirt, und der heißt Bartender_Bruno, so wie dieser Wirt seit W3 Bruno Fass heißt (27.08.2026, gestrichenes `komposit:true`; Preis und Begründung in `phase-g8-figurenfarben.md`, G8-4). **Offen:** sein Porträt zeigt noch volles dunkles Haar, das Blatt eine Halbglatze — das Porträt wird ausgetauscht, nicht das Blatt. Ohne Grafikpaket läuft er weiter als Held-Komposit: Haar h3 (kurz schwarz), Oberteil Stufe 0 (rot), Hose Stufe 2 (blau), Schuhe Stufe 2. **G7:** Anker von (20, 39) auf (24, 38), Ostseite, vor den Marktständen. **IN1:** zum Feierabend steht er nicht mehr dort, sondern hinter seiner Theke im Gasthaus (Haus 3 der Südzeile ist seither betretbar). Der Anker gilt für den Rest der Schicht unverändert.
