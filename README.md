...
Der erste Dienstantritt läuft seit E1 als Szene: fünf Anrisstafeln, dann ein Empfang bei Knöterich im selben Gesprächsfenster, das auch das Dorf benutzt. Antworten wählen wie unten beschrieben. Der Einstellungsvordruck steckt dahinter und bleibt aus der Szene, aus dem Startbild und aus dem Amt lesbar; `ÜBERSPRINGEN` auf der ersten Tafel führt direkt zu ihm.
...
| `tools/empfang-pruef.mjs` | prüft E1 im echten Browser: der Anriss blättert einzeln, die Szene öffnet mit Porträt und vier Antworten, Esc und Kreuz und Klick daneben prallen ab, der Treppeneffekt schaltet Nachfragen frei, beide Ausgänge starten den Dienst, das HUD tritt zurück und kommt wieder. Stellt fest statt zu messen, Exit-Code 1 bei der ersten Abweichung |
